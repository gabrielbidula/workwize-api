...
test('register a customer', function () {
...
test('can not register a customer without a name', function () {
    $this->json('POST', route('api.auth.suppliers.signup'), [
        'email' => 'user@gmail.com',
        'password' => 'Secret@2023',
        'password_confirmation' => 'Secret@2023',
...
test('can not register a customer without an email', function () {
    $this->json('POST', route('api.auth.suppliers.signup'), [
        'name' => 'User',
        'password' => 'Secret@2023',
        'password_confirmation' => 'Secret@2023',
...
test('can not register a customer without a password', function () {
    $this->json('POST', route('api.auth.suppliers.signup'), [
        'name' => 'User',
        'email' => 'user@gmail.com',
        'password_confirmation' => 'Secret@2023',
...
test('can not register a customer without a password confirmation', function () {
    $this->json('POST', route('api.auth.suppliers.signup'), [
        'name' => 'User',
        'email' => 'user@gmail.com',
        'password' => 'Secret@2023',
